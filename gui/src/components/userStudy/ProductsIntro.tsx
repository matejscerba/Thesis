...
function ProductsIntro() {
  return (
    <div>
      ...
      <img style={{ maxHeight: "300px", maxWidth: "500px" }} src="/media/images/product.png" alt="Product" />
      <Typography variant="body1">
      ...
      <img style={{ maxHeight: "300px", maxWidth: "500px" }} src="/media/images/candidates.png" alt="Candidates" />
      ...
      <img
        ...
        src="/media/images/unseen_statistics.png"
        alt="Candidates"
      />
      ...
      <img
        style={{ maxHeight: "300px", maxWidth: "500px" }}
        src="/media/images/stopping_criteria.png"
        alt="Stopping criteria"
      />
      ...
      <img style={{ maxHeight: "300px", maxWidth: "500px" }} src="/media/images/alternatives.png" alt="Alternatives" />
      ...
      <img
        style={{ maxHeight: "300px", maxWidth: "500px" }}
        src="/media/images/discarded.png"
        alt="Discarded products"
      />
    </div>
  );
}
